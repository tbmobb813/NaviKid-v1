# KidMap Slash Commands

This project includes custom slash commands to help you develop efficiently.
...
**When to use:** Quick project overview, daily standup
...
1. Start your session: `/init`
2. Check priorities: `/tasks`
3. Begin development: `/dev`
