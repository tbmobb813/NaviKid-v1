...
const SmartNotification = ({ notification, onDismiss, onAction, isInApp = true }) => {
  ...
  const getIcon = () => {
    switch (type) {
      case 'reminder':
        return _jsx(Clock, { size: 20, color: Colors.primary });
      case 'weather':
        return _jsx(MapPin, { size: 20, color: Colors.warning });
      case 'safety':
        return _jsx(Shield, { size: 20, color: Colors.error });
      case 'achievement':
        return _jsx(Trophy, { size: 20, color: Colors.secondary });
    }
  };
    ...
    children: _jsxs(View, {
      ...
      children: [
        _jsxs(View, {
          ...
          children: [
            getIcon(),
            _jsx(Text, { style: styles.title, children: title }),
            _jsx(Pressable, {
          ...
          _jsxs(Pressable, {
            ...
            children: [
              actionText === 'Schedule Notification' &&
                _jsx(Bell, { size: 14, color: Colors.primary }),
              _jsx(Text, {
                style: styles.actionText,
                children: isScheduling ? 'Scheduling...' : actionText,
              }),
            ],
          }),
        scheduledFor &&
          _jsxs(View, {
            ...
            children: [
              _jsx(Clock, { size: 12, color: Colors.textLight }),
              _jsxs(Text, {
                style: styles.scheduleText,
                children: ['Scheduled for ', scheduledFor.toLocaleString()],
              }),
            ],
          }),
        priority === 'high' &&
          _jsx(View, {
            ...
            children: _jsx(Text, { style: styles.priorityText, children: 'HIGH PRIORITY' }),
          }),
      ],
    }),
  });
