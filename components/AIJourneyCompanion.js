      ...
      _jsxs(Pressable, {
        ...
        children: [
          _jsxs(Animated.View, {
            ...
            children: [
              _jsx(Text, { style: styles.avatarEmoji, children: getMoodEmoji() }),
              _jsx(Bot, { size: 16, color: Colors.white, style: styles.botIcon }),
            ],
          }),
          _jsxs(View, {
            style: styles.messagePreview,
            children: [
              _jsx(Text, { style: styles.companionName, children: 'Buddy' }),
              _jsx(Text, {
          ...
          _jsx(Pressable, {
            ...
            children: voiceEnabled
              ? _jsx(Volume2, { size: 16, color: Colors.primary })
              : _jsx(VolumeX, { size: 16, color: Colors.textLight }),
          }),
        ],
      }),
      isExpanded &&
        _jsxs(View, {
          ...
          children: [
            _jsx(Text, { style: styles.fullMessage, children: currentMessage.text }),
            _jsxs(View, {
              ...
              children: [
                _jsxs(Pressable, {
                  ...
                  children: [
                    _jsx(Sparkles, { size: 16, color: Colors.primary }),
                    _jsx(Text, { style: styles.actionButtonText, children: 'Quiz Me!' }),
                  ],
                }),
                _jsxs(Pressable, {
                  style: styles.actionButton,
                  ...
                  children: [
                    _jsx(Bot, { size: 16, color: Colors.primary }),
                    _jsx(Text, { style: styles.actionButtonText, children: 'Tell Me More' }),
                  ],
                }),
              ],
            }),
