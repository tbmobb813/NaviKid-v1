  ...
  const content = useMemo(() => {
    if (loading || isLoading) {
      return _jsxs(View, {
        ...
        children: [
          _jsx(ActivityIndicator, { color: Colors.primary }),
          _jsx(Text, { style: styles.loadingText, children: 'Fetching weather\u2026' }),
        ],
      });
    }
    if (isError || !data) {
      return _jsxs(View, {
        ...
        children: [
          _jsx(AlertCircle, { size: 18, color: Colors.error }),
          _jsx(Text, { style: styles.errorText, children: 'Unable to load weather' }),
          _jsxs(Pressable, {
            style: styles.retry,
            onPress: () => refetch(),
            testID: testId ? `${testId}-retry` : undefined,
            children: [
              _jsx(RefreshCw, { size: 14, color: '#FFFFFF' }),
              _jsx(Text, { style: styles.retryText, children: 'Retry' }),
            ],
          }),
        ],
      });
    }
    return _jsx(WeatherCard, {
      weather: {
