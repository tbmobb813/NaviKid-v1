    ...
    children: _jsxs(View, {
      ...
      children: [
        _jsxs(View, {
          style: styles.header,
          children: [
            _jsx(Text, { style: styles.title, children: 'Your Pet Companion' }),
            _jsx(Pressable, {
              style: styles.closeButton,
              onPress: onClose,
              children: _jsx(Text, { style: styles.closeText, children: '\u00D7' }),
            }),
          ],
        }),
        _jsxs(View, {
          ...
          children: [
            _jsx(Animated.View, {
              ...
              children: _jsx(Text, { style: styles.petEmoji, children: getPetEmoji() }),
            }),
            _jsxs(View, {
              style: styles.petInfo,
              children: [
                _jsx(Text, { style: styles.petName, children: pet.name }),
                _jsxs(Text, { style: styles.petStage, children: [getPetStage(), ' ', pet.type] }),
                _jsxs(Text, { style: styles.petLevel, children: ['Level ', pet.level] }),
              ],
            }),
          ],
        }),
            ...
            _jsxs(View, {
              ...
              children: [
                _jsxs(View, {
                  ...
                  children: [
                    _jsx(Heart, { size: 16, color: getHappinessColor() }),
                    _jsx(Text, { style: styles.statLabel, children: 'Happiness' }),
                    _jsxs(Text, { style: styles.statValue, children: [pet.happiness, '%'] }),
                  ],
                }),
                _jsx(View, {
            ...
            _jsxs(View, {
              ...
              children: [
                _jsxs(View, {
                  style: styles.statHeader,
                  children: [
                    _jsx(Zap, { size: 16, color: getEnergyColor() }),
                    _jsx(Text, { style: styles.statLabel, children: 'Energy' }),
                    _jsxs(Text, { style: styles.statValue, children: [pet.energy, '%'] }),
                  ],
                }),
                _jsx(View, {
                  style: styles.progressBar,
            ...
            _jsxs(View, {
              ...
              children: [
                _jsxs(View, {
                  style: styles.statHeader,
                  children: [
                    _jsx(Star, { size: 16, color: Colors.secondary }),
                    _jsx(Text, { style: styles.statLabel, children: 'Experience' }),
                    _jsxs(Text, { style: styles.statValue, children: [pet.experience, '/100'] }),
                  ],
                }),
                _jsx(View, {
                  style: styles.progressBar,
        ...
        _jsxs(View, {
          ...
          children: [
            _jsxs(Pressable, {
              ...
              onPress: feedPet,
              children: [
                _jsx(Text, { style: styles.actionEmoji, children: '\uD83C\uDF4E' }),
                _jsx(Text, { style: styles.actionText, children: 'Feed' }),
              ],
            }),
            _jsxs(Pressable, {
              style: styles.actionButton,
              ...
              children: [
                _jsx(Text, { style: styles.actionEmoji, children: '\uD83C\uDFBE' }),
                _jsx(Text, { style: styles.actionText, children: 'Play' }),
              ],
            }),
            _jsxs(Pressable, {
              style: styles.actionButton,
              children: [
                ...
                _jsx(Text, { style: styles.actionText, children: 'Adventure' }),
              ],
            }),
          ],
        }),
