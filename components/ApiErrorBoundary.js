    ...
    if (this.state.hasError) {
      ...
      return _jsx(View, {
        ...
        children: _jsxs(View, {
          ...
          children: [
            _jsx(ErrorIcon, { size: 48, color: Colors.error, style: styles.icon }),
            _jsx(Text, { style: styles.title, children: 'Oops! Something went wrong' }),
            _jsx(Text, { style: styles.message, children: this.getErrorMessage() }),
            this.props.showNetworkStatus &&
              _jsxs(View, {
                ...
                children: [
                  ...
                  networkState.type &&
                    _jsxs(Text, {
                      style: styles.networkType,
                      children: ['(', networkState.type, ')'],
                    }),
                ],
              }),
            canRetry &&
