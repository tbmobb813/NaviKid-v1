...
const DevicePingHandler = ({ testId }) => {
  ...
  return _jsx(View, {
    ...
    testID: testId,
    children: _jsxs(View, {
      style: [styles.pingCard, isRinging && styles.ringingCard],
      children: [
        _jsxs(View, {
          style: styles.pingHeader,
          children: [
            _jsx(View, { style: styles.pingIconContainer, children: getPingIcon() }),
            _jsx(Pressable, {
              style: styles.dismissButton,
              onPress: handleDismissPing,
              children: _jsx(X, { size: 20, color: Colors.textLight }),
            }),
          ],
        }),
        _jsx(Text, { style: styles.pingTitle, children: getPingTitle() }),
        activePing.message &&
          _jsx(Text, { style: styles.pingMessage, children: activePing.message }),
        _jsx(View, {
          style: styles.pingActions,
          children:
            activePing.type === 'location'
              ? _jsxs(_Fragment, {
                  children: [
                    ...
                    _jsxs(Pressable, {
                      ...
                      children: [
                        _jsx(MapPin, { size: 16, color: '#FFFFFF' }),
                        _jsx(Text, { style: styles.shareButtonText, children: 'Share Location' }),
                      ],
                    }),
                  ],
                })
              : _jsxs(Pressable, {
                  ...
                  children: [
                    _jsx(CheckCircle, { size: 16, color: '#FFFFFF' }),
                    _jsx(Text, { style: styles.acknowledgeButtonText, children: 'Acknowledge' }),
                  ],
                }),
        }),
        _jsxs(Text, {
          style: styles.pingTime,
          children: ['Received ', new Date(activePing.requestedAt).toLocaleTimeString()],
        }),
      ],
    }),
  });
