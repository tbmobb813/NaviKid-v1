...
const VoiceNavigation = ({
  ...
  return _jsxs(View, {
    ...
    testID: testId ?? 'voice-nav',
    children: [
      _jsxs(View, {
        style: styles.stepContainer,
        children: [
          _jsx(Text, { style: styles.stepText, children: currentStep }),
          transcript
            ? _jsxs(Text, { style: styles.subtle, children: ['You said: ', transcript] })
            : null,
          errorMsg ? _jsx(Text, { style: styles.errorText, children: errorMsg }) : null,
        ],
      }),
      _jsxs(View, {
        ...
        children: [
          _jsxs(Pressable, {
            ...
            children: [
              _jsx(Mic, { size: 24, color: '#FFFFFF' }),
              _jsx(Text, {
                style: styles.buttonText,
                children: isListening ? 'Listening...' : 'Push to talk',
              }),
            ],
          }),
          _jsxs(Pressable, {
            ...
            children: [
              _jsx(Volume2, { size: 24, color: '#FFFFFF' }),
              _jsx(Text, {
                style: styles.buttonText,
                children: isSpeaking ? 'Speaking...' : 'Repeat',
              }),
            ],
          }),
        ],
      ...
      isListening &&
        _jsxs(View, {
          ...
          children: [
            _jsx(Text, { style: styles.commandsTitle, children: 'Say things like:' }),
            _jsx(Text, { style: styles.commandText, children: '\u2022 "Where am I?"' }),
            _jsx(Text, { style: styles.commandText, children: '\u2022 "Repeat directions"' }),
            _jsx(Text, { style: styles.commandText, children: '\u2022 "Call for help"' }),
            _jsx(Text, { style: styles.commandText, children: '\u2022 "How much time left?"' }),
          ],
        }),
    ],
  });
