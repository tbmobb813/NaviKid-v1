...
const SearchWithSuggestions = ({
  ...
  const getSuggestionIcon = (type) => {
    switch (type) {
      ...
      case 'popular':
        return _jsx(Star, { size: 16, color: Colors.warning });
      case 'place':
        return _jsx(MapPin, { size: 16, color: Colors.primary });
      default:
        return _jsx(MapPin, { size: 16, color: Colors.textLight });
    }
  };
  const renderSuggestion = ({ item }) =>
    _jsxs(Pressable, {
      ...
      children: [
        ...
        _jsx(Text, { style: styles.suggestionText, numberOfLines: 1, children: item.text }),
      ],
    });
  return _jsxs(View, {
