...
const RegionalTransitCard = () => {
  ...
  const renderTransitSystem = ({ item }) =>
    _jsxs(View, {
      style: styles.transitItem,
      children: [
        _jsx(View, {
          style: [styles.transitIcon, { backgroundColor: item.color }],
          children: getTransitIcon(item.type),
        }),
        _jsxs(View, {
          style: styles.transitInfo,
          children: [
            _jsx(Text, { style: styles.transitName, children: item.name }),
            _jsxs(Text, {
              style: styles.transitType,
              children: [
    ...
    children: [
      _jsxs(View, {
        ...
        children: [
          _jsxs(Text, {
            style: styles.title,
            children: ['Transit Systems in ', currentRegion.name],
          }),
          _jsx(Text, { style: styles.subtitle, children: currentRegion.country }),
        ],
      }),
      _jsx(FlatList, {
        data: transitSystems,
