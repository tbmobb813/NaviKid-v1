...
const PlaceCard = ({ place, onPress }) => {
  ...
  return _jsxs(Pressable, {
    ...
    children: [
      _jsx(View, { style: styles.iconContainer, children: getIcon() }),
      _jsxs(View, {
        style: styles.textContainer,
        children: [
          _jsx(Text, { style: styles.name, children: place.name }),
          _jsx(Text, { style: styles.address, numberOfLines: 1, children: place.address }),
        ],
      }),
    ],
  });
