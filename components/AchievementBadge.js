    ...
    children: [
      achievement.unlocked
        ? _jsxs(_Fragment, {
            children: [
              _jsx(Text, {
                style: [styles.icon, { fontSize: dimensions.fontSize }],
                children: achievement.icon,
              }),
              _jsx(Star, { size: 16, color: '#FFD700', style: styles.star }),
            ],
          })
        : _jsx(Lock, { size: 24, color: Colors.textLight }),
      _jsx(Text, {
        style: [
          styles.title,
      ...
      achievement.unlocked &&
        _jsxs(Text, {
          style: [styles.points, { fontSize: dimensions.textSize - 2 }],
