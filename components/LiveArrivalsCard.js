...
const LiveArrivalsCard = ({
  ...
  const renderArrival = ({ item }) =>
    _jsxs(View, {
      style: [styles.arrivalItem, item.arrivalTime <= 1 && styles.urgentArrival],
      children: [
        _jsx(TransitStepIndicator, {
          step: {
            id: item.id,
            type: item.type,
            line: item.line,
        ...
        _jsxs(View, {
          ...
          children: [
            ...
            item.platform &&
              _jsxs(Text, { style: styles.platformText, children: ['Platform ', item.platform] }),
          ],
        }),
        _jsxs(View, {
          ...
          children: [
            item.arrivalTime <= 1 &&
              _jsx(Bell, { size: 14, color: Colors.warning, style: styles.alertIcon }),
            _jsx(Text, {
              style: [styles.arrivalTime, { color: getArrivalTimeColor(item.arrivalTime) }],
    ...
    children: [
      _jsxs(View, {
        ...
        children: [
          _jsxs(View, {
            ...
            children: [
              _jsx(MapPin, { size: 20, color: Colors.primary, style: styles.stationIcon }),
              _jsx(Text, { style: styles.stationName, children: stationName }),
            ],
          }),
          _jsxs(View, {
            ...
            children: [
              _jsxs(View, {
                ...
                children: [
                  ...
                  _jsx(Text, { style: styles.updateText, children: actualLastUpdated }),
                  arrivalsQuery.isError &&
                    _jsx(AlertCircle, { size: 14, color: Colors.error, style: { marginLeft: 4 } }),
                ],
              }),
              _jsx(Pressable, {
      ...
      arrivalsQuery.isError
        ? _jsxs(View, {
            ...
            children: [
              _jsx(AlertCircle, { size: 24, color: Colors.error }),
              _jsx(Text, {
              ...
              _jsx(Pressable, {
                ...
                onPress: handleRefresh,
                children: _jsx(Text, { style: styles.retryText, children: 'Try Again' }),
              }),
            ],
          })
        : arrivals.length > 0
          ...
          : _jsx(View, {
              ...
              children: _jsx(Text, {
                ...
                children: arrivalsQuery.isLoading ? 'Loading arrivals...' : 'No arrivals scheduled',
              }),
            }),
    ],
  });
