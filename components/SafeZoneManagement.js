        ...
        _jsxs(View, {
          ...
          children: [
            _jsx(Pressable, {
              ...
              onPress: resetForm,
              children: _jsx(ArrowLeft, { size: 24, color: Colors.primary }),
            }),
            _jsx(Text, {
              style: styles.headerTitle,
              children: editingZone ? 'Edit Safe Zone' : 'Add Safe Zone',
            }),
          ],
        }),
        _jsxs(ScrollView, {
            ...
            _jsxs(View, {
              ...
              children: [
                ...
                _jsxs(View, {
                  style: styles.inputGroup,
                  children: [
                    _jsx(Text, { style: styles.label, children: 'Location' }),
                    _jsxs(View, {
                    ...
                    _jsxs(Pressable, {
                      ...
                      children: [
                        _jsx(MapPin, { size: 16, color: Colors.primary }),
                        _jsx(Text, {
                ...
                _jsxs(View, {
                  style: styles.inputGroup,
                  children: [
                    _jsx(Text, { style: styles.label, children: 'Radius (meters)' }),
                    _jsx(TextInput, {
                      style: styles.input,
                ...
                _jsxs(View, {
                  style: styles.inputGroup,
                  children: [
                    _jsx(Text, { style: styles.label, children: 'Notifications' }),
                    _jsxs(Pressable, {
                      ...
                      children: [
                        _jsx(Text, { style: styles.toggleLabel, children: 'Notify on entry' }),
                        formData.notifications.onEntry
                          ? _jsx(ToggleRight, { size: 24, color: Colors.primary })
                          : _jsx(ToggleLeft, { size: 24, color: Colors.textLight }),
                      ],
                    }),
                    _jsxs(Pressable, {
                      style: styles.toggleRow,
                      ...
                      children: [
                        _jsx(Text, { style: styles.toggleLabel, children: 'Notify on exit' }),
              ...
              children: [
                _jsx(Pressable, {
                  ...
                  children: _jsx(Text, {
                    ...
                    children: editingZone ? 'Update Safe Zone' : 'Create Safe Zone',
                  }),
                }),
                _jsx(Pressable, {
                  style: styles.cancelButton,
                  onPress: resetForm,
                  children: _jsx(Text, { style: styles.cancelButtonText, children: 'Cancel' }),
                }),
              ],
            }),
          ],
    ...
    children: [
      _jsxs(View, {
        ...
        children: [
          ...
          _jsx(Text, { style: styles.headerTitle, children: 'Safe Zones' }),
          _jsx(Pressable, {
          ...
          safeZones.length === 0
            ? _jsxs(View, {
                ...
                children: [
                  ...
                  _jsx(Text, { style: styles.emptyTitle, children: 'No Safe Zones' }),
                  _jsx(Text, {
                        ...
                        children: [
                          _jsxs(View, {
                            ...
                            children: [
                              ...
                              _jsxs(Text, {
                                style: styles.zoneNotifications,
                                children: [
                                  'Notifications: ',
                          ...
                          _jsx(Pressable, {
                            ...
                            children: zone.isActive
                              ? _jsx(ToggleRight, { size: 32, color: Colors.success })
                              : _jsx(ToggleLeft, { size: 32, color: Colors.textLight }),
                          }),
                        ],
                      }),
                      _jsxs(View, {
                        style: styles.zoneActions,
                        children: [
                          _jsxs(Pressable, {
                            style: styles.actionButton,
                            onPress: () => handleEdit(zone),
                            children: [
                              _jsx(Edit, { size: 16, color: Colors.primary }),
                              _jsx(Text, { style: styles.actionButtonText, children: 'Edit' }),
                            ],
                          }),
                          _jsxs(Pressable, {
                            ...
                            children: [
                              _jsx(Trash2, { size: 16, color: Colors.error }),
                              _jsx(Text, {
