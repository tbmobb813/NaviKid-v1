      ...
      _jsxs(View, {
        ...
        children: [
          _jsx(View, {
            ...
            children: _jsx(Lock, { size: 32, color: Colors.primary }),
          }),
          _jsx(Text, { style: styles.title, children: currentTitle }),
          _jsx(Text, { style: styles.subtitle, children: currentSubtitle }),
        ],
      }),
      _jsxs(View, {
          ...
          _jsxs(View, {
            ...
            children: [
              ...
              _jsx(Pressable, {
                ...
                children: showPin
                  ? _jsx(EyeOff, { size: 20, color: Colors.textLight })
                  : _jsx(Eye, { size: 20, color: Colors.textLight }),
              }),
            ],
          }),
          _jsx(View, {
              ...
              children: row.map((key, keyIndex) =>
                _jsx(
                  Pressable,
                  {
                    ...
                    disabled: key === '',
                    children: _jsx(Text, { style: styles.keypadButtonText, children: key }),
                  },
                  keyIndex,
                ),
              ),
        ...
        children: [
          _jsx(Pressable, {
            ...
            children: _jsx(Text, {
              ...
              children: isLoading ? 'Verifying...' : step === 'confirm' ? 'Confirm' : 'Submit',
            }),
          }),
          _jsx(Pressable, {
