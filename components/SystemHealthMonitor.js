...
const SystemHealthMonitor = ({ testId }) => {
  ...
  const runHealthChecks = async () => {
    ...
    const memoryStatus =
      Platform.OS === 'web' && performance.memory
    ...
    children: [
        ...
        children: [
          _jsxs(View, {
            ...
            children: [
              ...
              _jsxs(Text, {
                style: [styles.statusText, { color: getStatusColor(overallStatus) }],
                children: [
                  'System ',
          ...
          children: [
            errorCount > 0 &&
              _jsxs(Text, {
                ...
                children: [errorCount, ' error', errorCount > 1 ? 's' : '', ' found'],
              }),
            warningCount > 0 &&
              _jsxs(Text, {
                style: styles.warningSummary,
                children: [warningCount, ' warning', warningCount > 1 ? 's' : '', ' found'],
              }),
          ],
        }),
      _jsx(View, {
        style: styles.checksList,
              ...
              children: [
                _jsxs(View, {
                  ...
                  children: [
                    ...
                    _jsx(Text, { style: styles.checkName, children: check.name }),
                  ],
                }),
                _jsx(Text, { style: styles.checkMessage, children: check.message }),
                _jsxs(Text, {
                  style: styles.checkTime,
                  children: ['Last checked: ', new Date(check.lastChecked).toLocaleTimeString()],
                }),
              ],
            },
            check.id,
      ...
      overallStatus === 'error' &&
        _jsxs(View, {
          ...
          children: [
            _jsx(Text, { style: styles.actionTitle, children: 'Recommended Actions:' }),
            _jsxs(Text, {
