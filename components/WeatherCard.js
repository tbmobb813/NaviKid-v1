          ...
          _jsxs(View, {
            ...
            children: [
              _jsxs(Text, {
                ...
                children: [weather.temperature, unitLabel],
              }),
              _jsx(Text, { style: styles.condition, children: weather.condition }),
            ],
          }),
        ],
      }),
      _jsx(Text, { style: styles.recommendation, children: weather.recommendation }),
    ],
  });
};
