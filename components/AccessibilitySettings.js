...
const AccessibilitySettings = ({ onBack }) => {
  ...
  const SettingItem = ({ icon, title, description, value, onValueChange }) =>
    _jsxs(View, {
      ...
      children: [
        _jsx(View, { style: styles.settingIcon, children: icon }),
        _jsxs(View, {
          style: styles.settingContent,
          children: [
            _jsx(Text, {
              style: [styles.settingTitle, accessibilitySettings.largeText && styles.largeText],
              children: title,
            }),
            _jsx(Text, {
              style: [
    ...
    children: [
      onBack &&
        _jsxs(Pressable, {
          ...
          onPress: onBack,
          children: [
            _jsx(ArrowLeft, { size: 20, color: Colors.primary }),
            _jsx(Text, { style: styles.backText, children: 'Back to Settings' }),
          ],
        }),
      _jsx(Text, {
      ...
      _jsx(SettingItem, {
        icon: _jsx(Eye, { size: 24, color: Colors.primary }),
        title: 'Large Text',
      ...
      _jsx(SettingItem, {
        icon: _jsx(Settings, { size: 24, color: Colors.primary }),
        title: 'High Contrast',
      ...
      _jsx(SettingItem, {
        icon: _jsx(Volume2, { size: 24, color: Colors.primary }),
      ...
      _jsx(SettingItem, {
        icon: _jsx(Zap, { size: 24, color: Colors.primary }),
